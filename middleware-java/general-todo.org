...
** TODO Different sensor capabilities - also expressing the sensor false +ve/-ve rates
** TODO Extracting timing information from MOOS and passing it onto the CI
