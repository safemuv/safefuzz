...
The CI requests must be passed as serialised Behaviour objects to the middleware
The middleware has to have a thread monitoring reverse communications from the CI
The middleware also has to have a thread monitoring connections from the fault injection
