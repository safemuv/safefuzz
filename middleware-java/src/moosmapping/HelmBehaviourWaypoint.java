...
public class HelmBehaviourWaypoint extends MOOSBehaviour {
	...
	public HelmBehaviourWaypoint(MOOSProcess parent, String vehicleName, String startPos, double speed, double radius, double nm_radius) {
