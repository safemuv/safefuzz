package fuzzexperiment.runner.jmetal.customalg;
...
public class NSGAII_JRH<S extends Solution<?>> extends AbstractGeneticAlgorithm<S, List<S>> {
	...
	public void logPopulationToFile(FileWriter fw) throws IOException {
