...
public class StubDSLLoader implements DSLLoader {
	...
	public Mission loadMission() {
		...
		addRobotWithSonar(mission, "henry", new Point(20.0, 0.0), 1.5,  5.0, 25, 0.99, 0.03, 0.07);
		addRobotWithSonar(mission, "frank", new Point(40.0, 0.0), 1.0,  5.0, 10, 0.99, 0.03, 0.02);
		addRobotWithSonar(mission, "ella",  new Point(60.0, 0.0), 0.75, 5.0, 50, 0.99, 0.03, 0.06);
