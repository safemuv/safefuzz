...
public class FuzzingExperimentModifier extends fuzzingengine.exptgenerator.FuzzingExperimentModifier {
	...
	public FuzzingExperimentModifier(Grammar g, Mission mission) {
		super(mission);
		rng = new Random();
