...
public class GeneratedFuzzingSpec {
	...
	try {
	   ...
	   OperationParameterSet ops1 = new OperationParameterSet("JSONPointChange-Fixed-1", "JSONPointChange");
	   		...
	   		ops1.addParameter(opp1);
	   			...
	   			OperationParameter opp2 = new DoubleRangeOperationParameter("X", -0.2, 0.2);
	   		...
	   		ops1.addParameter(opp2);
	   			...
	   			OperationParameter opp3 = new DoubleRangeOperationParameter("Y", -0.2, 0.2);
	   		...
	   		ops1.addParameter(opp3);
	   			...
	   			OperationParameter opp4 = new DoubleRangeOperationParameter("Z", -0.2, 0.2);
	   ...
	   OperationParameterSet ops2 = new OperationParameterSet("JSONPointChange-RandomOffset-1", "JSONPointChange");
	   		...
	   		ops2.addParameter(opp5);
	   			...
	   			OperationParameter opp6 = new DoubleRangeOperationParameter("X", -0.2, 0.2);
	   		...
	   		ops2.addParameter(opp6);
	   			...
	   			OperationParameter opp7 = new DoubleRangeOperationParameter("Y", -0.2, 0.2);
	   		...
	   		ops2.addParameter(opp7);
	   			...
	   			OperationParameter opp8 = new DoubleRangeOperationParameter("Z", -0.2, 0.2);
	   ...
	   OperationParameterSet ops3 = new OperationParameterSet("JSONPointChange-FixedOffset", "JSONPointChange");
	   		...
	   		ops3.addParameter(opp10);
	   			...
	   			OperationParameter opp11 = new DoubleRangeOperationParameter("X", -0.1, 0.1);
	   		...
	   		ops3.addParameter(opp11);
	   			...
	   			OperationParameter opp12 = new DoubleRangeOperationParameter("Y", -0.1, 0.1);
	   		...
	   		ops3.addParameter(opp12);
	   			...
	   			OperationParameter opp13 = new DoubleRangeOperationParameter("Z", 0.0, 0.0);
	   ...
	   OperationParameterSet ops4 = new OperationParameterSet("PathPointChange-multiple-elements", "PathPointChanges");
	   		...
	   		ops4.addParameter(opp15);
	   			...
	   			OperationParameter opp16 = new DoubleRangeOperationParameter("X", -0.2, 0.2);
	   		...
	   		ops4.addParameter(opp16);
	   			...
	   			OperationParameter opp17 = new DoubleRangeOperationParameter("Y", -0.2, 0.2);
	   		...
	   		ops4.addParameter(opp17);
	   			...
	   			OperationParameter opp18 = new DoubleRangeOperationParameter("Z", -0.2, 0.2);
	...
	simMapping.setComponentFuzzingInfo("CalibrationDefinitions", FuzzingSimMapping.FuzzingNature.NO_MODIFICATIONS, Optional.empty(), Optional.empty(), true);
		...
		false, Optional.empty(), Optional.of(1.0));
			...
			simMapping.addOperationParameterSetForVariable("s004_calibration_points.yaml", ops3, "frameB_1");
			simMapping.addOperationParameterSetForVariable("s004_calibration_points.yaml", ops3, "frameB_2");
			simMapping.addOperationParameterSetForVariable("s004_calibration_points.yaml", ops3, "frameB_3");
			simMapping.addOperationParameterSetForVariable("s004_calibration_points.yaml", ops3, "frameB_4");
			simMapping.addOperationParameterSetForVariable("s004_calibration_points.yaml", ops3, "frameB_5");
