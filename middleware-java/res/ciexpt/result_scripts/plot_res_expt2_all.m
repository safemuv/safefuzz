function plot_res_expt2_all()
  plot_res_expt2_int_metric("ciexpt-casestudy2-threshold750.res", 3, "casestudy2_completed_sweeps-750.pdf", "Number of completed sweeps", -0.5, 10);
  plot_res_expt2_hist(      "ciexpt-casestudy2-threshold750.res", 4, "casestudy2_final_distance-750.pdf",   "Final distance from base at end", 0, 250);
plot_res_expt2_hist(      "ciexpt-casestudy2-threshold750.res", 6, "casestudy2_final_energy-750.pdf",   "Total energy on robots at end", 0, 2800);
