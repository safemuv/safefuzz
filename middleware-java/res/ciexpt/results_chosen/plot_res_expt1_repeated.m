function plot_res_expt1
	...
	m = dlmread("ciexpt-casestudy1-optimal-repeated.res", ",");
	...
	print("-dpdf", "casestudy1_optimal_repeated_missed_detections_standardonly.pdf");
	...
	print("-dpdf", "casestudy1_optimal_repeated_missed_detections.pdf");
endfunction
