...
. ./set_paths.shpAntler targ_shoreside.moos > console-logs/shoreside-out 2> console-logs/shoreside-err  &
...
pAntler targ_brian.moos > console-logs/brian-out 2> console-logs/brian-err  &
