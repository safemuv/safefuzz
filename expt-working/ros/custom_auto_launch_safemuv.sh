...
xterm -hold -e /bin/bash -l -c "roslaunch $SCEN_LAUNCH_BASE/$1/launch/$1_sim.launch" &
sleep 15
echo "Starting SAFEMUV Docker container"
xterm -hold -e docker run --network host -v /home/$USER/catkin_ws/src/safemuv_ros/safemuv_shared/:/catkin_ws/src/safemuv_shared afi_core /bin/bash -c "source /catkin_ws/devel/setup.bash && roslaunch safemuv_shared $1_afi_bringup.launch" &
