...
set_target_properties(PROJ4::proj PROPERTIES
  ...
  IMPORTED_LINK_INTERFACE_LIBRARIES_RELEASE "-lm;pthread"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib64/libproj.a"
  )

list(APPEND _IMPORT_CHECK_TARGETS PROJ4::proj )
list(APPEND _IMPORT_CHECK_FILES_FOR_PROJ4::proj "${_IMPORT_PREFIX}/lib64/libproj.a" )
